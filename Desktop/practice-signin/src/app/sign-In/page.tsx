...
const signInPage = () => {
  ...
  const onSubmit = (data: SignInFormData) => {
    console.log(data);
    // Handle form submission logic here (e.g., call an API to sign in)
  };
  ...
  return (
    <div className="flex flex-col md:flex-row h-screen">
      ...
      <div className="w-full lg:w-1/2 flex flex-col justify-center px-8 lg:px-24 bg-background">
        <h1 className="text-3xl font-semibold mb-4 w-[363px] h-[45px] top-[284px] left-[771px]  " >Welcome to Start.</h1>
